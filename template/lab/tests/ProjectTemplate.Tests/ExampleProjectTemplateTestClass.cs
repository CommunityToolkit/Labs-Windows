...
public partial class ExampleProjectTemplateTestClass : VisualUITestBase
{
    ...
    public void SimpleUIExamplePageTest(ExampleProjectTemplateTestPage page)
    {
        ...
        var propertySizer = page.FindDescendant<ProjectTemplate_ClassicBinding>();

        Assert.IsNotNull(propertySizer);

        var propertySizerByName = page.FindDescendant("ProjectTemplateControl");

        Assert.IsNotNull(propertySizerByName);
    }
