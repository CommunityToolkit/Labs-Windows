...
[ToolkitSample(id: nameof(CompositionCollectionViewControlSample), "Templated control", description: "A sample for showing how to create and use a templated control.")]
public sealed partial class CompositionCollectionViewControlSample : Page
{
    public CompositionCollectionViewControlSample()
    {
