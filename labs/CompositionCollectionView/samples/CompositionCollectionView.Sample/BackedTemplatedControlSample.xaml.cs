...
[ToolkitSample(id: nameof(BackedCompositionCollectionViewControlSample), "Backed templated control", description: "A sample for showing how to create and use a templated control with a backed resource dictionary.")]
public sealed partial class BackedCompositionCollectionViewControlSample : Page
{
    public BackedCompositionCollectionViewControlSample()
    {
