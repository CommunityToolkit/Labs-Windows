...
[ToolkitSample(id: nameof(CompositionCollectionViewTemplatedSample), "Templated control", description: "A sample for showing how to create and use a templated control.")]
public sealed partial class CompositionCollectionViewTemplatedSample : Page
{
    public CompositionCollectionViewTemplatedSample()
    {
