...
/// You can choose to start here or from the <see cref="CompositionCollectionView_ClassicBinding"/> or <see cref="CompositionCollectionView_xBind"/> example components. Remove unused components and rename as appropriate.
/// </summary>
public partial class CompositionCollectionView : Panel
{
    /// <summary>
    /// Identifies the <see cref="Orientation"/> property.
    /// </summary>
    public static readonly DependencyProperty OrientationProperty =
        DependencyProperty.Register(nameof(Orientation), typeof(Orientation), typeof(CompositionCollectionView), new PropertyMetadata(null, OnOrientationChanged));
    ...
    {
        if (dependencyObject is CompositionCollectionView panel)
        {
