...
public partial class CompositionCollectionView_ClassicBinding : Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="CompositionCollectionView_ClassicBinding"/> class.
    /// </summary>
    public CompositionCollectionView_ClassicBinding()
    {
        this.DefaultStyleKey = typeof(CompositionCollectionView_ClassicBinding);
    }
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(CompositionCollectionView_ClassicBinding),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((CompositionCollectionView_ClassicBinding)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
