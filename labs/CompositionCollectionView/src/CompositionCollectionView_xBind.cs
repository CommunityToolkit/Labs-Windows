...
/// </summary>
public partial class CompositionCollectionView_xBind: Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="CompositionCollectionView_xBind"/> class.
    /// </summary>
    public CompositionCollectionView_xBind()
    {
        this.DefaultStyleKey = typeof(CompositionCollectionView_xBind);
    ...
    public static readonly DependencyProperty ItemPaddingProperty = DependencyProperty.Register(
        nameof(ItemPadding),
        typeof(Thickness),
        typeof(CompositionCollectionView_xBind),
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(CompositionCollectionView_xBind),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((CompositionCollectionView_xBind)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
