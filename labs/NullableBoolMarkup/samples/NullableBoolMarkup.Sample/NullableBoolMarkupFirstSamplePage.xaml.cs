...
namespace NullableBoolMarkup.Sample
{
    ...
    [ToolkitSample(id: nameof(NullableBoolMarkupFirstSamplePage), "Simple Options", description: "A sample page for showing how to do simple options.")]
    public sealed partial class NullableBoolMarkupFirstSamplePage : Page
    {
        public NullableBoolMarkupFirstSamplePage()
        {
