...
/// You can choose to start here or from the <see cref="SettingsControls_ClassicBinding"/> or <see cref="SettingsControls_xBind"/> example components. Remove unused components and rename as appropriate.
/// </summary>
