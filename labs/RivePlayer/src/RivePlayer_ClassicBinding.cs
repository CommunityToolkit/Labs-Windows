...
public partial class RivePlayer_ClassicBinding : Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="RivePlayer_ClassicBinding"/> class.
    /// </summary>
    public RivePlayer_ClassicBinding()
    {
        this.DefaultStyleKey = typeof(RivePlayer_ClassicBinding);
    }
    ...
    public static readonly DependencyProperty ItemPaddingProperty = DependencyProperty.Register(
        nameof(ItemPadding),
        typeof(Thickness),
        typeof(RivePlayer_ClassicBinding),
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(RivePlayer_ClassicBinding),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((RivePlayer_ClassicBinding)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
