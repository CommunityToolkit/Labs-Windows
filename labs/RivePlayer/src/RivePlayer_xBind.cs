...
/// </summary>
public partial class RivePlayer_xBind: Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="RivePlayer_xBind"/> class.
    /// </summary>
    public RivePlayer_xBind()
    {
        this.DefaultStyleKey = typeof(RivePlayer_xBind);
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(RivePlayer_xBind),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((RivePlayer_xBind)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
