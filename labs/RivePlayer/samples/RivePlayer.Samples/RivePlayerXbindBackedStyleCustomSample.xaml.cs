...
[ToolkitSample(id: nameof(RivePlayerXbindBackedStyleCustomSample), "Backed templated control (restyled)", description: "A sample for showing how to create and use a templated control with a backed resource dictionary and a custom style.")]
public sealed partial class RivePlayerXbindBackedStyleCustomSample : Page
{
    public RivePlayerXbindBackedStyleCustomSample()
    {
