...
/// You can choose to start here or from the <see cref="TitleBar_ClassicBinding"/> or <see cref="TitleBar_xBind"/> example components. Remove unused components and rename as appropriate.
/// </summary>
public partial class TitleBar : Panel
{
    ...
    public static readonly DependencyProperty OrientationProperty =
        DependencyProperty.Register(nameof(Orientation), typeof(Orientation), typeof(TitleBar), new PropertyMetadata(null, OnOrientationChanged));
    ...
    {
        if (dependencyObject is TitleBar panel)
        {
