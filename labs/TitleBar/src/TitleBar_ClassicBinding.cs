...
public partial class TitleBar_ClassicBinding : Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="TitleBar_ClassicBinding"/> class.
    /// </summary>
    public TitleBar_ClassicBinding()
    {
        this.DefaultStyleKey = typeof(TitleBar_ClassicBinding);
    }
    ...
    public static readonly DependencyProperty ItemPaddingProperty = DependencyProperty.Register(
        nameof(ItemPadding),
        typeof(Thickness),
        typeof(TitleBar_ClassicBinding),
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(TitleBar_ClassicBinding),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((TitleBar_ClassicBinding)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
