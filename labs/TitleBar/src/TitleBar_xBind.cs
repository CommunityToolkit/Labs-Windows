...
/// </summary>
public partial class TitleBar_xBind: Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="TitleBar_xBind"/> class.
    /// </summary>
    public TitleBar_xBind()
    {
        this.DefaultStyleKey = typeof(TitleBar_xBind);
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(TitleBar_xBind),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((TitleBar_xBind)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
