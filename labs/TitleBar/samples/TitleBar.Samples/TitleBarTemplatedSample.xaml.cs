...
[ToolkitSample(id: nameof(TitleBarTemplatedSample), "Templated control", description: "A sample for showing how to create and use a templated control.")]
public sealed partial class TitleBarTemplatedSample : Page
{
    public TitleBarTemplatedSample()
    {
