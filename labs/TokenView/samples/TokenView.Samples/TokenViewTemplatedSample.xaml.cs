...
[ToolkitSample(id: nameof(TokenViewTemplatedSample), "Templated control", description: "A sample for showing how to create and use a templated control.")]
public sealed partial class TokenViewTemplatedSample : Page
{
    public TokenViewTemplatedSample()
    {
