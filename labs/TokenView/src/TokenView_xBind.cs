...
/// </summary>
public partial class TokenView_xBind: Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="TokenView_xBind"/> class.
    /// </summary>
    public TokenView_xBind()
    {
        this.DefaultStyleKey = typeof(TokenView_xBind);
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(TokenView_xBind),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((TokenView_xBind)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
