...
/// You can choose to start here or from the <see cref="TokenView_ClassicBinding"/> or <see cref="TokenView_xBind"/> example components. Remove unused components and rename as appropriate.
/// </summary>
public partial class TokenView : Panel
{
    /// <summary>
    /// Identifies the <see cref="Orientation"/> property.
    /// </summary>
    public static readonly DependencyProperty OrientationProperty =
        DependencyProperty.Register(nameof(Orientation), typeof(Orientation), typeof(TokenView), new PropertyMetadata(null, OnOrientationChanged));
    ...
    {
        if (dependencyObject is TokenView panel)
        {
