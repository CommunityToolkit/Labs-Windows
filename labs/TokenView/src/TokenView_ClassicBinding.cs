...
public partial class TokenView_ClassicBinding : Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="TokenView_ClassicBinding"/> class.
    /// </summary>
    public TokenView_ClassicBinding()
    {
        this.DefaultStyleKey = typeof(TokenView_ClassicBinding);
    }
    ...
    public static readonly DependencyProperty ItemPaddingProperty = DependencyProperty.Register(
        nameof(ItemPadding),
        typeof(Thickness),
        typeof(TokenView_ClassicBinding),
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(TokenView_ClassicBinding),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((TokenView_ClassicBinding)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
