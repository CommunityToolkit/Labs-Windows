...
[ToolkitSample(id: nameof(MarqueeTextTemplatedSample), "Templated control", description: "A sample for showing how to create and use a templated control.")]
public sealed partial class MarqueeTextTemplatedSample : Page
{
    public MarqueeTextTemplatedSample()
    {
