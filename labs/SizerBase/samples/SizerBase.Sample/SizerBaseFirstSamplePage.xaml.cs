...
namespace SizerBase.Sample
{
    ...
    [ToolkitSample(id: nameof(SizerBaseFirstSamplePage), "Simple Options", description: "A sample page for showing how to do simple options.")]
    public sealed partial class SizerBaseFirstSamplePage : Page
    {
        public SizerBaseFirstSamplePage()
        {
