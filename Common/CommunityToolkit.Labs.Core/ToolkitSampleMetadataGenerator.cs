...
namespace CommunityToolkit.Labs.Core
{
    ...
    public partial class ToolkitSampleMetadataGenerator : ISourceGenerator
    {
        ...
        static private string BuildRegistrationCallsFromMetadata(IEnumerable<ToolkitSampleMetadata> sampleMetadata)
        {
    ...
    {{
        {
            ...
            static string MetadataToRegistryCall(ToolkitSampleMetadata metadata)
            {
                return @$"yield return new {nameof(ToolkitSampleMetadata)}({nameof(ToolkitSampleCategory)}.{metadata.Category}, {nameof(ToolkitSampleSubcategory)}.{metadata.Subcategory}, ""{metadata.DisplayName}"", ""{metadata.Description}"", ""{metadata.AssemblyQualifiedName}"");";
            }
        }
        ...
        private static ToolkitSampleMetadata ReconstructSampleMetadata(INamedTypeSymbol typeSymbol, AttributeData attributeData)
        {
            ...
            var attachedTypeFullyQualifiedName = typeSymbol.ToDisplayString(NullableFlowState.NotNull, SymbolDisplayFormat.FullyQualifiedFormat).Replace("global::", "");

            return new ToolkitSampleMetadata(reconstructedAttribute.Category, reconstructedAttribute.Subcategory, reconstructedAttribute.DisplayName, reconstructedAttribute.Description, attachedTypeFullyQualifiedName);
        }
