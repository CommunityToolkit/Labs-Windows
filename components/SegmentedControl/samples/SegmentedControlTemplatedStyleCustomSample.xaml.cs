...
[ToolkitSample(id: nameof(SegmentedControlTemplatedStyleCustomSample), "Templated control (restyled)", description: "A sample for showing how to create a use and templated control with a custom style.")]
public sealed partial class SegmentedControlTemplatedStyleCustomSample : Page
{
    public SegmentedControlTemplatedStyleCustomSample()
    {
