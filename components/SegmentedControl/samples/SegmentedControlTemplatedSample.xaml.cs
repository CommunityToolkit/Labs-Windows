...
[ToolkitSample(id: nameof(SegmentedControlTemplatedSample), "Templated control", description: "A sample for showing how to create and use a templated control.")]
public sealed partial class SegmentedControlTemplatedSample : Page
{
    public SegmentedControlTemplatedSample()
    {
