...
[ToolkitSample(id: nameof(SegmentedControlXbindBackedSample), "Backed templated control", description: "A sample for showing how to create and use a templated control with a backed resource dictionary.")]
public sealed partial class SegmentedControlXbindBackedSample : Page
{
    public SegmentedControlXbindBackedSample()
    {
