...
public partial class SegmentedControl_ClassicBinding : Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="SegmentedControl_ClassicBinding"/> class.
    /// </summary>
    public SegmentedControl_ClassicBinding()
    {
        this.DefaultStyleKey = typeof(SegmentedControl_ClassicBinding);
    }
    ...
    public static readonly DependencyProperty ItemPaddingProperty = DependencyProperty.Register(
        nameof(ItemPadding),
        typeof(Thickness),
        typeof(SegmentedControl_ClassicBinding),
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(SegmentedControl_ClassicBinding),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((SegmentedControl_ClassicBinding)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
