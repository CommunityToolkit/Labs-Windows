...
/// </summary>
public partial class SegmentedControl_xBind: Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="SegmentedControl_xBind"/> class.
    /// </summary>
    public SegmentedControl_xBind()
    {
        this.DefaultStyleKey = typeof(SegmentedControl_xBind);
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(SegmentedControl_xBind),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((SegmentedControl_xBind)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
