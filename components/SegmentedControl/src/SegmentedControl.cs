...
/// You can choose to start here or from the <see cref="SegmentedControl_ClassicBinding"/> or <see cref="SegmentedControl_xBind"/> example components. Remove unused components and rename as appropriate.
/// </summary>
public partial class SegmentedControl : Panel
{
    /// <summary>
    /// Identifies the <see cref="Orientation"/> property.
    /// </summary>
    public static readonly DependencyProperty OrientationProperty =
        DependencyProperty.Register(nameof(Orientation), typeof(Orientation), typeof(SegmentedControl), new PropertyMetadata(null, OnOrientationChanged));
    ...
    {
        if (dependencyObject is SegmentedControl panel)
        {
