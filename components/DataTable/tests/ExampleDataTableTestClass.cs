...
[TestClass]
public partial class ExampleDataTableTestClass : VisualUITestBase
{
    ...
    public void SimpleUIExamplePageTest(ExampleDataTableTestPage page)
    {
        ...
        var componentByName = page.FindDescendant("DataTableControl");
    ...
    [UIThreadTestMethod]
    public async Task SimpleAsyncUIExamplePageTest(ExampleDataTableTestPage page)
    {
