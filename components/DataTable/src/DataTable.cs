...
/// You can choose to start here or from the <see cref="DataTable_ClassicBinding"/> or <see cref="DataTable_xBind"/> example components. Remove unused components and rename as appropriate.
/// </summary>
public partial class DataTable : Panel
{
    ...
    public static readonly DependencyProperty OrientationProperty =
        DependencyProperty.Register(nameof(Orientation), typeof(Orientation), typeof(DataTable), new PropertyMetadata(null, OnOrientationChanged));
    ...
    {
        if (dependencyObject is DataTable panel)
        {
