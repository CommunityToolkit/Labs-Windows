...
[ToolkitSample(id: nameof(ShimmerXbindBackedSample), "Backed templated control", description: "A sample for showing how to create and use a templated control with a backed resource dictionary.")]
public sealed partial class ShimmerXbindBackedSample : Page
{
    public ShimmerXbindBackedSample()
    {
