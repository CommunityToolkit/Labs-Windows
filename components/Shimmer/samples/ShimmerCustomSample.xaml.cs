...
[ToolkitSample(id: nameof(ShimmerCustomSample), "Custom control", description: $"A sample for showing how to create and use a {nameof(Shimmer)} custom control.")]
public sealed partial class ShimmerCustomSample : Page
{
    public ShimmerCustomSample()
    {
