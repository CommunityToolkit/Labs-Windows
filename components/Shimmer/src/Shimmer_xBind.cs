...
/// </summary>
public partial class Shimmer_xBind: Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="Shimmer_xBind"/> class.
    /// </summary>
    public Shimmer_xBind()
    {
        this.DefaultStyleKey = typeof(Shimmer_xBind);
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(Shimmer_xBind),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((Shimmer_xBind)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
