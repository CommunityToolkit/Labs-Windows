...
public partial class Shimmer_ClassicBinding : Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="Shimmer_ClassicBinding"/> class.
    /// </summary>
    public Shimmer_ClassicBinding()
    {
        this.DefaultStyleKey = typeof(Shimmer_ClassicBinding);
    }
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(Shimmer_ClassicBinding),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((Shimmer_ClassicBinding)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
