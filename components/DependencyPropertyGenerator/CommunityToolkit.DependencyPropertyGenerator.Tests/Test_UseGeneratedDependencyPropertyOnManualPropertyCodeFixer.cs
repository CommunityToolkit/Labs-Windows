...
public class Test_UseGeneratedDependencyPropertyOnManualPropertyCodeFixer
{
    ...
    [TestMethod]
    [DataRow("int?", "int?", "null", "")]
    [DataRow("int?", "int?", "new PropertyMetadata(null)", "")]
    [DataRow("int?", "int?", "new PropertyMetadata(default(int?))", "")]
    [DataRow("int?", "int?", "new PropertyMetadata(0)", "(DefaultValue = 0)")]
    [DataRow("int?", "int?", "new PropertyMetadata(default(int))", "(DefaultValue = 0)")]
    [DataRow("int?", "object", "null", "(PropertyType = typeof(object))")]
    [DataRow("int?", "object", "new PropertyMetadata(null)", "(PropertyType = typeof(object))")]
    [DataRow("int?", "object", "new PropertyMetadata(default(int?))", "(PropertyType = typeof(object))")]
