...
[ToolkitSample(id: nameof(GradientSliderTemplatedSample), "Templated control", description: "A sample for showing how to create and use a templated control.")]
public sealed partial class GradientSliderTemplatedSample : Page
{
    public GradientSliderTemplatedSample()
    {
