...
/// </summary>
public partial class GradientSlider_xBind: Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="GradientSlider_xBind"/> class.
    /// </summary>
    public GradientSlider_xBind()
    {
        this.DefaultStyleKey = typeof(GradientSlider_xBind);
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(GradientSlider_xBind),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((GradientSlider_xBind)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
