...
/// You can choose to start here or from the <see cref="GradientSlider_ClassicBinding"/> or <see cref="GradientSlider_xBind"/> example components. Remove unused components and rename as appropriate.
/// </summary>
public partial class GradientSlider : Panel
{
    /// <summary>
    /// Identifies the <see cref="Orientation"/> property.
    /// </summary>
    public static readonly DependencyProperty OrientationProperty =
        DependencyProperty.Register(nameof(Orientation), typeof(Orientation), typeof(GradientSlider), new PropertyMetadata(null, OnOrientationChanged));
    ...
    {
        if (dependencyObject is GradientSlider panel)
        {
