...
public partial class GradientSlider_ClassicBinding : Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="GradientSlider_ClassicBinding"/> class.
    /// </summary>
    public GradientSlider_ClassicBinding()
    {
        this.DefaultStyleKey = typeof(GradientSlider_ClassicBinding);
    }
    ...
    public static readonly DependencyProperty ItemPaddingProperty = DependencyProperty.Register(
        nameof(ItemPadding),
        typeof(Thickness),
        typeof(GradientSlider_ClassicBinding),
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(GradientSlider_ClassicBinding),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((GradientSlider_ClassicBinding)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
