...
/// <summary>
/// A <see cref="ColorPalette"/> based on the three most prominant colors.
/// </summary>
public class ProminencePalette : ColorPalette
{
    /// <summary>
    ...
    public static readonly DependencyProperty PrimaryProperty =
        DependencyProperty.Register(nameof(Primary), typeof(Color), typeof(ProminencePalette), new PropertyMetadata(Colors.Transparent));
    ...
    public static readonly DependencyProperty SecondaryProperty =
        DependencyProperty.Register(nameof(Secondary), typeof(Color), typeof(ProminencePalette), new PropertyMetadata(Colors.Transparent));
    ...
    public static readonly DependencyProperty TertiaryProperty =
        DependencyProperty.Register(nameof(Tertiary), typeof(Color), typeof(ProminencePalette), new PropertyMetadata(Colors.Transparent));
