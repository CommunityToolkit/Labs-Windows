...
public partial class StretchPanel : Panel
{
    ...
    public static readonly DependencyProperty OrientationProperty =
        DependencyProperty.Register(nameof(Orientation), typeof(Orientation), typeof(StretchPanel), new PropertyMetadata(null, OnOrientationChanged));
    ...
    {
        if (dependencyObject is StretchPanel panel)
        {
