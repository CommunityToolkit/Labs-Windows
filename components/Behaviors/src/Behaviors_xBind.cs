...
/// </summary>
public partial class Behaviors_xBind: Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="Behaviors_xBind"/> class.
    /// </summary>
    public Behaviors_xBind()
    {
        this.DefaultStyleKey = typeof(Behaviors_xBind);
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(Behaviors_xBind),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((Behaviors_xBind)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
