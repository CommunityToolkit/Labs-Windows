...
public partial class Behaviors_ClassicBinding : Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="Behaviors_ClassicBinding"/> class.
    /// </summary>
    public Behaviors_ClassicBinding()
    {
        this.DefaultStyleKey = typeof(Behaviors_ClassicBinding);
    }
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(Behaviors_ClassicBinding),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((Behaviors_ClassicBinding)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
