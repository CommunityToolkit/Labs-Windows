...
/// You can choose to start here or from the <see cref="Behaviors_ClassicBinding"/> or <see cref="Behaviors_xBind"/> example components. Remove unused components and rename as appropriate.
/// </summary>
public partial class Behaviors : Panel
{
    /// <summary>
    /// Identifies the <see cref="Orientation"/> property.
    /// </summary>
    public static readonly DependencyProperty OrientationProperty =
        DependencyProperty.Register(nameof(Orientation), typeof(Orientation), typeof(Behaviors), new PropertyMetadata(null, OnOrientationChanged));
    ...
    {
        if (dependencyObject is Behaviors panel)
        {
