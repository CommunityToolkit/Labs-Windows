...
[ToolkitSample(id: nameof(BehaviorsXbindBackedStyleCustomSample), "Backed templated control (restyled)", description: "A sample for showing how to create and use a templated control with a backed resource dictionary and a custom style.")]
public sealed partial class BehaviorsXbindBackedStyleCustomSample : Page
{
    public BehaviorsXbindBackedStyleCustomSample()
    {
