...
namespace CompositionCollectionViewExperiment.Tests;

[TestClass]
public partial class ExampleCompositionCollectionViewTestClass : VisualUITestBase
{
    // If you don't need access to UI objects directly or async code, use this pattern.
    [TestMethod]
    public void SimpleSynchronousExampleTest()
    {
        var assembly = typeof(CompositionCollectionView).Assembly;
        var type = assembly.GetType(typeof(CompositionCollectionView).FullName ?? string.Empty);

        Assert.IsNotNull(type, "Could not find CompositionCollectionView type.");
        Assert.AreEqual(typeof(CompositionCollectionView), type, "Type of CompositionCollectionView does not match expected type.");
    }
    ...
    public void SimpleUIExamplePageTest(ExampleCompositionCollectionViewTestPage page)
    {
        ...
        var componentByName = page.FindDescendant("CompositionCollectionViewControl");
    ...
    [UIThreadTestMethod]
    public async Task SimpleAsyncUIExamplePageTest(ExampleCompositionCollectionViewTestPage page)
    {
