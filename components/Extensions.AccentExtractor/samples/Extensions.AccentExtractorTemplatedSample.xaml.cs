...
[ToolkitSample(id: nameof(Extensions.AccentExtractorTemplatedSample), "Templated control", description: "A sample for showing how to create and use a templated control.")]
public sealed partial class Extensions.AccentExtractorTemplatedSample : Page
{
    public Extensions.AccentExtractorTemplatedSample()
    {
