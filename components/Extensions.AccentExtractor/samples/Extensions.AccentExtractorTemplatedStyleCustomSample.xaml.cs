...
[ToolkitSample(id: nameof(Extensions.AccentExtractorTemplatedStyleCustomSample), "Templated control (restyled)", description: "A sample for showing how to create a use and templated control with a custom style.")]
public sealed partial class Extensions.AccentExtractorTemplatedStyleCustomSample : Page
{
    public Extensions.AccentExtractorTemplatedStyleCustomSample()
    {
