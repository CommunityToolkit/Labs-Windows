...
/// </summary>
public partial class OpacityMaskView_xBind: Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="OpacityMaskView_xBind"/> class.
    /// </summary>
    public OpacityMaskView_xBind()
    {
        this.DefaultStyleKey = typeof(OpacityMaskView_xBind);
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(OpacityMaskView_xBind),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((OpacityMaskView_xBind)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
