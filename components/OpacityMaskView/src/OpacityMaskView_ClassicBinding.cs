...
public partial class OpacityMaskView_ClassicBinding : Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="OpacityMaskView_ClassicBinding"/> class.
    /// </summary>
    public OpacityMaskView_ClassicBinding()
    {
        this.DefaultStyleKey = typeof(OpacityMaskView_ClassicBinding);
    }
    ...
    public static readonly DependencyProperty ItemPaddingProperty = DependencyProperty.Register(
        nameof(ItemPadding),
        typeof(Thickness),
        typeof(OpacityMaskView_ClassicBinding),
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(OpacityMaskView_ClassicBinding),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((OpacityMaskView_ClassicBinding)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
