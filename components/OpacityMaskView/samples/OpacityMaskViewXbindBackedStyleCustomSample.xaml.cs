...
[ToolkitSample(id: nameof(OpacityMaskViewXbindBackedStyleCustomSample), "Backed templated control (restyled)", description: "A sample for showing how to create and use a templated control with a backed resource dictionary and a custom style.")]
public sealed partial class OpacityMaskViewXbindBackedStyleCustomSample : Page
{
    public OpacityMaskViewXbindBackedStyleCustomSample()
    {
