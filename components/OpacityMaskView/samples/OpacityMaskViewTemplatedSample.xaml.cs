...
[ToolkitSample(id: nameof(OpacityMaskViewTemplatedSample), "Templated control", description: "A sample for showing how to create and use a templated control.")]
public sealed partial class OpacityMaskViewTemplatedSample : Page
{
    public OpacityMaskViewTemplatedSample()
    {
