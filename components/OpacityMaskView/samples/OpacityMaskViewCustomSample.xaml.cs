...
[ToolkitSample(id: nameof(OpacityMaskViewCustomSample), "Custom control", description: $"A sample for showing how to create and use a {nameof(OpacityMaskView)} custom control.")]
public sealed partial class OpacityMaskViewCustomSample : Page
{
    public OpacityMaskViewCustomSample()
    {
